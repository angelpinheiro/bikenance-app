...
sealed class MaintenanceType(val name: String, val componentType: ComponentType) {
    ...
    object CablesAndHousingMaintenance : MaintenanceType("CABLES_AND_HOUSING_MAINTENANCE", ComponentType.CableHousing)

    object CassetteMaintenance : MaintenanceType("CASSETTE_MAINTENANCE", ComponentType.Cassette)
    object RearDerailleurMaintenance : MaintenanceType("REAR_DERAILLEUR_MAINTENANCE", ComponentType.RearDerailleurs)
    ...
    object DropperPostMaintenance : MaintenanceType("DROPPER_POST_MAINTENANCE", ComponentType.DropperPost)
    ...
    object RearSuspensionMaintenance : MaintenanceType("REAR_SUSPENSION_MAINTENANCE", ComponentType.RearSuspension)

    object ThruAxleMaintenance : MaintenanceType("THRU_AXLE_MAINTENANCE", ComponentType.ThruAxle)
    object FrameBearingsMaintenance : MaintenanceType("FRAME_BEARINGS_MAINTENANCE", ComponentType.FrameBearings)
